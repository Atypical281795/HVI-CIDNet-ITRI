...
def option():
    ...
    # choose a scheduler
    parser.add_argument('--cos_restart_cyclic', action='store_true', default=False)
    parser.add_argument('--cos_restart', action='store_true', default=True)

    # warmup training
    parser.add_argument('--warmup_epochs', type=int, default=3, help='warmup_epochs')
    parser.add_argument('--start_warmup', action='store_true', default=True, help='turn False to train without warmup') 
    ...
    parser.add_argument('--data_train_CEC'         , type=str, default='./datasets/CEC_Dataset/train')
    ...
    parser.add_argument('--data_val_CEC'         , type=str, default='./datasets/CEC_Dataset/test')
    ...
    parser.add_argument('--data_valgt_CEC'          , type=str, default='./datasets/CEC_Dataset/test/clean/')
    ...
    parser.add_argument('--grad_detect', action='store_true', default=False, help='if gradient explosion occurs, turn-on it')
    parser.add_argument('--grad_clip', action='store_true', default=True, help='if gradient fluctuates too much, turn-on it')
    
    
    # choose which dataset you want to train, please only set one "True"
    parser.add_argument('--lol_v1', action='store_true', default=False)
    parser.add_argument('--lolv2_real', action='store_true', default=False)
    parser.add_argument('--lolv2_syn', action='store_true', default=False)
    parser.add_argument('--lol_blur', action='store_true', default=False)
    parser.add_argument('--SID', action='store_true', default=False)
    parser.add_argument('--SICE_mix', action='store_true', default=False)
    parser.add_argument('--SICE_grad', action='store_true', default=False)
    parser.add_argument('--CEC', action='store_true', default=False)
